import { Rebase, maximum, minimum, toElastic, Token, toAmount, toShare } from '@telefy/teleswap-core-sdk'
...
export class KashiMediumRiskLendingPair {
  ...
  public get currentUserBorrowAmount(): JSBI {
    if (JSBI.equal(this.userBorrowPart, JSBI.BigInt(0))) return JSBI.BigInt(0)
